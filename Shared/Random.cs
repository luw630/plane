...
{
    /// <summary>
    /// 这是从 System.Random 复制的源代码. 并加上了序列化功能.
    /// </summary>
    public class Random : IBBWriter, IBBReader
    {
        ...
        public void WriteTo(ByteBuffer bb)
        {
            bb.VarWrite(inext);
            bb.VarWrite(inextp);
            bb.VarWrite(SeedArray);
        }

        public void ReadFrom(ByteBuffer bb)
        {
            bb.VarRead(ref inext);
            bb.VarRead(ref inextp);
            bb.VarRead(ref SeedArray);
        }
